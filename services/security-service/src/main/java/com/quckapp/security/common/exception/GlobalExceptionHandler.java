...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleSecurityServiceException(SecurityServiceException ex) {
        log.error("Security service error: {} [{}]", ex.getMessage(), ex.getErrorCode());
